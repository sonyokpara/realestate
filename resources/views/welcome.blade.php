    ...
    <body>
        ...
        <div class="boxed_wrapper">
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo"><a href="index.html"><img src="{{asset('assets/frontend-assets/images/logo-2.png')}}" alt="" title=""></a></div>
            ...
            <!-- banner-section -->
            <section class="banner-section" style="background-image: url(assets/frontend-assets/images/banner/banner-1.jpg);">
