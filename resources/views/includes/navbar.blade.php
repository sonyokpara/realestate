        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{($user->photo)? url('assets/profile-photos/'.$user->photo) : url('assets/images/no-image.png')}}" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{($user->photo)? url('assets/profile-photos/'.$user->photo) : url('assets/images/no-image.png')}}" alt="">
                        </div>
                    ...
                    <ul class="list-unstyled p-1">
                        ...
                        <li class="dropdown-item py-2">
                            <a href="{{route('admin.chg-password')}}" class="text-body ms-0">
